...
const InternalRolesPage = () => {
  ...
  // Fetch permissions for the Internal context (for modal multi-select)
    ...
    <div>
      ...
      <div className="mx-4 mt-10">
        ...
        <ReusableTable
          ...
          emptyMessage="No Internal roles found."
        />
      </div>
...
export default InternalRolesPage;
