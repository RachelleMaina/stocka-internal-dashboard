...
interface PermissionsBackofficePageProps {
  appContext: "backoffice"; // or pass dynamically if reused
}

const PermissionsBackofficePage: React.FC<PermissionsBackofficePageProps> = ({
...
export default PermissionsBackofficePage;
